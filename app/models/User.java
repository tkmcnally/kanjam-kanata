...
public class User extends AppModel implements Subject {
    ...
    public static User create(final AuthUser authUser) {
        ...
        User.roles = Collections.singletonList(SecurityRole
            .findByRoleName(Constants.User.USER_ROLE));
        ...
        if (authUser instanceof KanJamIdentity) {
            final KanJamIdentity identity = (KanJamIdentity) authUser;
            ...
            //TicketBud ticket id.
            final String ticketId = identity.getTicketId();
            if(ticketId != null) {
